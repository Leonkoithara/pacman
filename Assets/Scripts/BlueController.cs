...
public class BlueController : MonoBehaviour
{
    ...
    void Start()
    {
		inside_house = true;
		up = true;
		home_position = new Vector3(0.0f, 0.84f, 0.0f);
		pacman_offset = new Vector3(1.0f, 0.0f, 0);
	...
	public IEnumerator scare()
	{
		...
		pacman.GetComponent<pacman_movement>().stimulated = false;
		pacman.GetComponent<pacman_movement>().offset = 0;
	}
